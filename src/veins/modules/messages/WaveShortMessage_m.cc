...
int WaveShortMessage::getStatus() const
{
    return this->Status;
}

void WaveShortMessage::setStatus(int Status)
{
    this->Status = Status;
}

double WaveShortMessage::getData() const
{
    return this->Data;
}

void WaveShortMessage::setData(double Data)
{
    this->Data = Data;
}
...
int WaveShortMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='S' && strcmp(fieldName, "Status")==0) return base+16;
    if (fieldName[0]=='D' && strcmp(fieldName, "Data")==0) return base+17;
...
std::string WaveShortMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 16: return long2string(pp->getStatus());
        case 17: return double2string(pp->getData());
        default: return "";
    }
}
...
bool WaveShortMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 16: pp->setStatus(string2long(value)); return true;
        case 17: pp->setData(string2double(value)); return true;
